<template>
  <div class="about">
    <h1>/about</h1>
  <p>This is a demo Project I started recently to practice building apps Vue with Typescript. I also wanted to make it interesting and helpful for people - so here I am and gathering listing starter for Vue applications.
  </p><p>
